...
type CompKey struct {
	...
	IterKey any    // optional iteration key to distinguish the same component reference in source code but different loop iterations
}
...
func MakeCompKey(id uint64, iterKey any) CompKey {
