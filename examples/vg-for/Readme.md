...
Open a browser at [http://localhost:8889/vg-for/](http://localhost:8889/vg-for/)
...
Again browse to [http://localhost:8889/vg-for/](http://localhost:8889/vg-for/) and refresh the browser.
